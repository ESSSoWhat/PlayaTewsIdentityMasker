...
class QProcessingWindow(QMainWindow):
    ...
    def create_left_panel(self):
        ...
        try:
            ...
            if self.face_swap_components and 'camera_source' in self.face_swap_components:
        ...
        try:
            if self.face_swap_components and 'face_detector' in self.face_swap_components:
                detection_layout.addWidget(self.face_swap_components['face_detector'])
            if self.face_swap_components and 'face_aligner' in self.face_swap_components:
    ...
    def create_face_processing_tab(self):
        ...
        try:
            ...
            # Face animator
            if self.face_swap_components and 'face_animator' in self.face_swap_components:
            ...
            # Face swap insight
            if self.face_swap_components and 'face_swap_insight' in self.face_swap_components:
            ...
            # Face swap DFM
            if self.face_swap_components and 'face_swap_dfm' in self.face_swap_components:
    ...
    def create_frame_processing_tab(self):
        ...
        try:
            # Frame adjuster
            if self.face_swap_components and 'frame_adjuster' in self.face_swap_components:
            ...
            # Stream output
            if self.face_swap_components and 'stream_output' in self.face_swap_components:
            ...
            scroll_layout.addWidget(QLabel("Frame Processing Components: Error Loading"))
    ...
    def create_all_controls_tab(self):
        ...
        try:
            for component_name in component_order:
                if self.face_swap_components and component_name in self.face_swap_components:
                    ...
                    scroll_layout.addWidget(QLabel(f"{component_name.replace('_', ' ').title()}: Not Available"))
    ...
    def create_streaming_tab(self):
        ...
        self.quality_combo = QComboBox()
        self.quality_combo.addItems(["1080p 60fps", "1080p 30fps", "720p 60fps", "720p 30fps", "480p 30fps"])
    ...
    def create_audio_tab(self):
        ...
        self.audio_input_combo.addItems(["Default Microphone", "System Audio", "Custom Device"])
        ...
        self.audio_output_combo.addItems(["Default Speakers", "Headphones", "System Audio"])
