...
This script ensures all modules (camera source, face detection, etc.) activate properly
"""
...
def create_module_activation_fix():
    """Create a comprehensive fix for module activation"""
    
    print("Creating Module Activation Fix...")
    
    # Create enhanced module launcher
    module_launcher_content = '''#!/usr/bin/env python3
"""
...
'''
    ...
    with open("module_activation_launcher.py", "w", encoding='utf-8') as f:
        f.write(module_launcher_content)
...
'''
    ...
    with open("start_module_activation.bat", "w") as f:
        f.write(batch_content)
    
    # Create comprehensive settings files
    ...
    # Global face swap state with all modules enabled
    global_state = {
        "camera_source": {
            "enabled": True,
            "device_idx": 0,
    ...
    print("Module activation launcher created: module_activation_launcher.py")
    print("Batch file created: start_module_activation.bat")
    print("Comprehensive settings files created")
    
    print("\\nTo launch with module activation fix:")
    print("   Run: .\\start_module_activation.bat")
    
    return True

if __name__ == "__main__":
    create_module_activation_fix() 