...
class FMask:
    ...
    def __init__(self, _from_pickled=False):
        """ """
        self._uuid: Union[bytes, None] = (
            uuid.uuid4().bytes if not _from_pickled else None
        )
    ...
    def get_mask_type(self) -> Union["FMask.Type", None]:
    ...
    def get_FImage_uuid(self) -> Union[bytes, None]:
        return self._FImage_uuid
