...
class UFaceMark(IState):
    ...
    def restore_state(self, state: dict):
        ...
        self._FLandmarks2D_list = [
            IState._restore_IState_obj(FLandmarks2D, lmrks_state)
            for lmrks_state in state["_FLandmarks2D_list"]
        ]
    ...
    def dump_state(self) -> dict:
        return {
            ...
            "_FLandmarks2D_list": tuple(
                IState._dump_IState_obj(fl) for fl in self._FLandmarks2D_list
            ),
    ...
    def get_UImage_uuid(self) -> Union[bytes, None]:
        return self._UImage_uuid
    ...
    def get_UPerson_uuid(self) -> Union[bytes, None]:
        return self._UPerson_uuid
    ...
    def get_FRect(self) -> Union["FRect", None]:
        return self._FRect
    ...
    def get_all_FLandmarks2D(self) -> List[FLandmarks2D]:
        return self._FLandmarks2D_list
    ...
    def add_FLandmarks2D(self, flmrks: FLandmarks2D):
        ...
        if self.get_FLandmarks2D_by_type(flmrks.get_type()) is not None:
            raise Exception(
                f"_FLandmarks2D_list already contains type {flmrks.get_type()}."
            )

        self._FLandmarks2D_list.append(flmrks)

    def get_FPose(self) -> Union[FPose, None]:
        return self._FPose
