...
def warp_affine(
    input_t: Tensor, affine_t: Tensor, output_size=None, dtype=None
) -> Tensor:
    """
    arguments
    ...
    affine_t = affine_t.transpose(op.affine_transpose_axes, dtype=np.float32).reshape(
        (-1, 3, 2)
    )
