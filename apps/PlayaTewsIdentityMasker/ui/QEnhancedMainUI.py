...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, 
                            ...
                            QMainWindow, QStatusBar, QToolBar, QDockWidget)
...
class QEnhancedMainUI(QMainWindow):
    ...
    def create_collapsible_sections(self, layout):
        ...
        # Input Settings
        input_group = self.create_collapsible_group("Input Settings", [
        ...
        face_group = self.create_collapsible_group("Face Processing", [
        ...
        # Output Settings
        output_group = self.create_collapsible_group("Output Settings", [
        ...
        performance_group = self.create_collapsible_group("Performance", [
        ...
        if self.voice_changer_backend:
            voice_group = self.create_collapsible_group("Voice Settings", [
                ("Voice Changer", QCheckBox, False),
                ("Effect Type", QComboBox, ["None", "Echo", "Pitch", "Reverb", "Robot"]),
    ...
    def setup_accessibility(self):
        ...
        self.setAccessibleDescription("Professional face-swapping and streaming application with enhanced UI")
    ...
    def setup_toolbar(self):
        ...
        settings_action = QAction("Settings", self)
        settings_action.setIcon(self.style().standardIcon(QStyleFactory.SP_FileDialogDetailedView))
        settings_action.triggered.connect(self.open_settings_window)
