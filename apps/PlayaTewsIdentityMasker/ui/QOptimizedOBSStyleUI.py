...
class QOptimizedOBSStyleUI(QWidget):
    ...
    def create_voice_changer_section(self):
        ...
        if self.voice_changer_backend:
            self.voice_changer_widget = QCompactVoiceChanger(
                self.voice_changer_backend.get_control_sheet()
            )
        else:
    ...
    def load_dfm_models(self):
        ...
        try:
            ...
            try:
                ...
                if self.dfm_models:
                    self.dfm_status_label.setText(
                        f"Loaded {len(self.dfm_models)} models"
                    )
                else:
    ...
    def load_dfm_models_fallback(self):
        ...
        try:
            ...
            if dfm_dir.exists():
                ...
                if self.dfm_models:
                    self.dfm_status_label.setText(
                        f"Loaded {len(self.dfm_models)} local models"
                    )
                else:
        ...
        try:
            ...
            if "face_swap_dfm" in self.face_swap_components:
                ...
                for model in available_models:
                    if (
                        model
                        and hasattr(model, "get_name")
                        and model.get_name() == model_name
                    ):
                        # Select the model
    ...
    def create_collapsible_viewers_section(self):
        ...
        if "face_align_viewer" in self.viewers_components:
            ...
            face_align_viewer.setSizePolicy(
        ...
        if "merged_frame_viewer" in self.viewers_components:
            ...
            merged_frame_viewer.setSizePolicy(
                QSizePolicy.Expanding, QSizePolicy.Expanding
            )
        ...
        if viewers:
            ...
            return QCollapsibleComponentWrapper(
                component=placeholder, title="Processing Views", is_opened=False
            )
    ...
    def create_collapsible_input_detection(self):
        ...
        if "camera_source" in self.face_swap_components:
            components.append(
                (self.face_swap_components["camera_source"], "Camera Source")
            )

        # Add detection components
        if "face_detector" in self.face_swap_components:
            components.append(
                (self.face_swap_components["face_detector"], "Face Detector")
            )
        if "face_aligner" in self.face_swap_components:
            components.append(
                (self.face_swap_components["face_aligner"], "Face Aligner")
            )
        ...
        if components:
            ...
            placeholder.setAlignment(Qt.AlignCenter)
            return QCollapsibleComponentWrapper(
                component=placeholder, title="Input & Detection", is_opened=False
            )
    ...
    def create_collapsible_face_processing(self):
        ...
        if "face_animator" in self.face_swap_components:
            components.append(
                (self.face_swap_components["face_animator"], "Face Animator")
            )
        if "face_swap_insight" in self.face_swap_components:
            components.append(
                (self.face_swap_components["face_swap_insight"], "Face Swap Insight")
            )
        if "face_swap_dfm" in self.face_swap_components:
            components.append(
                (self.face_swap_components["face_swap_dfm"], "Face Swap DFM")
            )
        ...
        if components:
            ...
            placeholder.setAlignment(Qt.AlignCenter)
            return QCollapsibleComponentWrapper(
                component=placeholder, title="Face Processing", is_opened=False
            )
    ...
    def create_collapsible_output_quality(self):
        ...
        if "frame_adjuster" in self.face_swap_components:
            components.append(
                (self.face_swap_components["frame_adjuster"], "Frame Adjuster")
            )
        ...
        if "stream_output" in self.face_swap_components:
            components.append(
                (self.face_swap_components["stream_output"], "Stream Output")
            )
        ...
        if components:
            ...
            placeholder.setAlignment(Qt.AlignCenter)
            return QCollapsibleComponentWrapper(
                component=placeholder, title="Output & Quality", is_opened=False
            )
    ...
    def setup_connections(self):
        ...
        if hasattr(self, "voice_changer_widget"):
            ...
            if hasattr(self.voice_changer_widget, "enabled_changed"):
                self.voice_changer_widget.enabled_changed.connect(
                    self.on_voice_changer_toggled
                )
            if hasattr(self.voice_changer_widget, "effect_changed"):
                self.voice_changer_widget.effect_changed.connect(
                    self.on_voice_effect_changed
                )
