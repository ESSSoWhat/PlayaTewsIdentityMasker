...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QTabWidget, QPushButton, QLabel, QGridLayout, QGroupBox, QScrollArea
...
class QDFMQuickAccessPanel(QXWidget):
    ...
    def setup_ui(self):
        ...
        for i in range(6):
            ...
            """)
            button.clicked.connect(lambda checked, idx=i: self.on_model_button_clicked(idx))
