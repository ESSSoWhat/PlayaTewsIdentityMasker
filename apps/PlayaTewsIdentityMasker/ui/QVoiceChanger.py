...
class QVoiceChanger(QWidget):
    ...
    def _create_main_tab(self):
        ...
        self.q_effect_type = QComboBoxCSWDynamicSingleSwitch(
            self.cs_voice_changer.effect_type, reflect_state_widgets=[effect_label]
        )
    ...
    def _create_effects_tab(self):
        ...
        self.q_formant_shift = QDoubleSpinBoxCSWNumber(
            self.cs_voice_changer.formant_shift
        )
        ...
        self.q_reverb_room_size = QDoubleSpinBoxCSWNumber(
            self.cs_voice_changer.reverb_room_size
        )
        ...
        self.q_reverb_damping = QDoubleSpinBoxCSWNumber(
            self.cs_voice_changer.reverb_damping
        )
        ...
        self.q_chorus_depth = QDoubleSpinBoxCSWNumber(
            self.cs_voice_changer.chorus_depth
        )
        ...
        self.q_distortion_amount = QDoubleSpinBoxCSWNumber(
            self.cs_voice_changer.distortion_amount
        )
        ...
        self.q_autotune_sensitivity = QDoubleSpinBoxCSWNumber(
            self.cs_voice_changer.autotune_sensitivity
        )
    ...
    def _create_devices_tab(self):
        ...
        self.q_input_device = QComboBoxCSWDynamicSingleSwitch(
            self.cs_voice_changer.input_device, reflect_state_widgets=[input_label]
        )
        ...
        self.q_output_device = QComboBoxCSWDynamicSingleSwitch(
            self.cs_voice_changer.output_device, reflect_state_widgets=[output_label]
        )
    ...
    def _apply_preset(self, preset_name):
        ...
        presets = {
            "helium": {"effect_type": 4, "pitch_shift": 4.0},  # HELIUM
            "deep": {"effect_type": 5, "pitch_shift": -4.0},  # DEEP
            "robot": {"effect_type": 3, "robot_rate": 0.5},  # ROBOT
            "echo": {"effect_type": 6, "echo_delay": 0.3, "echo_decay": 0.5},  # ECHO
            "reverb": {
            ...
            "distortion": {"effect_type": 9, "distortion_amount": 0.3},  # DISTORTION
            "autotune": {"effect_type": 10, "autotune_sensitivity": 0.1},  # AUTOTUNE
