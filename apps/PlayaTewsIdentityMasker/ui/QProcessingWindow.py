...
class QProcessingWindow(QMainWindow):
    ...
    def __init__(self, face_swap_components: Dict, parent=None):
        super().__init__(parent)
        self.face_swap_components = face_swap_components
    ...
    def setup_window(self):
        ...
        self.setWindowTitle("PlayaTewsIdentityMasker - Processing Controls")
        ...
        self.status_bar.showMessage("Processing controls ready")
