...
class QOptimizedFrameViewer(qtx.QXCollapsibleSection):
    ...
    def __init__(
        ...
        self._timer = qtx.QXTimer(
            interval=update_interval_ms, timeout=self._on_timer_update, start=True
        )
    ...
    def _log_performance_metrics(self):
        ...
        if total_updates > 0:
            ...
            print(
                f"FrameViewer Performance: {self._update_count} updates, {self._skip_count} skips ({skip_rate:.1f}% skip rate)"
            )
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "skip_rate": (
                (self._skip_count / (self._update_count + self._skip_count)) * 100
                if (self._update_count + self._skip_count) > 0
                else 0
            ),
