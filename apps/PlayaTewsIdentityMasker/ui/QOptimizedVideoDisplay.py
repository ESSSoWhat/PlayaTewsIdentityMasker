...
from PyQt5.QtGui import QPalette, QColor, QFont, QPixmap, QPainter, QImage
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, 
                            QPushButton, QToolButton, QComboBox, QFrame,
                            QSizePolicy, QApplication, QStyleFactory)
import numpy as np
...
class QOptimizedVideoDisplay(QWidget):
    ...
    def hide_controls(self):
        ...
        if self.controls_visible:
            ...
            self.fade_animation.finished.connect(lambda: self.control_panel.setVisible(False))
            self.fade_animation.start()
