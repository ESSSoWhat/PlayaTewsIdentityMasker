...
class QImprovedOBSStyleUI(QWidget):
    ...
    def create_main_action_buttons(self, layout):
        ...
        # Face swap toggle
        self.global_face_swap_btn = self.create_modern_button("Face Swap: ON", "#27ae60", "face-swap")
        ...
        for btn in [self.stream_btn, self.record_btn, self.global_face_swap_btn, self.settings_btn]:
